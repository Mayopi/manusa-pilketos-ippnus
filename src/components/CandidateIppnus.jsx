              ...
              <div key={candidate._id} className="col flex justify-center items-center lg:w-[32%] w-full my-5">
                <div className="card w-96 bg-base-200 group rounded shadow-xl cursor-pointer">
                  <figure className="relative">
                    <Image src={candidate.name == "Berliana Zahra Pramudhita" ? "/images/berliana-zahra-profile.png" : "/images/shofia-qutrotunnada-profile.png"} alt="Shoes" width={200} height={200} className="rounded" />
                  </figure>
